...
function Homepage($$payload, $$props) {
  push();
  $$payload.out += `<div class="home-page svelte-m5tp8k"><h1 class="svelte-m5tp8k"><svg id="Calque_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 770.39 63.49" class="line-drawing svelte-m5tp8k"><defs><style>
          .cls-1 {
            z-index: 100;
            fill: none;
            stroke: var(--ring);
